...
//função para habilitar o telefone residencial
$(document).ready(function(){
    $("#telefone_res").blur(function(){
        var tel = /^\([1-9]{2}\)[2-4]{1}[0-9]{3}\-[0-9]{4}$/;
        if(!tel.test($("#telefone_res").val())){
            if($("#telefone_res").val() == ''){
                alert("O telefone residencial é obrigatório, digite um número válido para prosseguir..");
            }else{
                alert("Telefone Residencial Inválido, insira um número válido!");
                document.getElementById('telefone_res').value=" ";
            }
...
//função para habilitar o telefone celular
$(document).ready(function(){
    $("#telefone_cel").blur(function(){
        var cel = /^\([1-9]{2}\)9[7-9]{1}[0-9]{3}\-[0-9]{4}$/;
        if(!cel.test($("#telefone_cel").val())){
            if($("#telefone_cel").val() == ''){
                alert("O telefone celular é obrigatório, digite um número válido para prosseguir..");
            }else{
                alert("Telefone Celular Inválido, insira um número válido!");
                document.getElementById('telefone_cel').value=" ";
            }
        }else{
